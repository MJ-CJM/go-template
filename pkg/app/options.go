// -*- coding:utf-8 -*-
// @Time : 2022/3/15 1:34 上午
// @Author: MJ-CJM
// @File : go-template/options
package app

import (
	cliflag "go-template/third_party/go-template/third_party/github.com/marmotedu/component-base/pkg/cli/flag"
)
