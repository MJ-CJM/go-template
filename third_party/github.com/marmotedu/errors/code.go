...
var (
	unknownCoder defaultCoder = defaultCoder{1, http.StatusInternalServerError, "An internal server error occurred", "http://go-template/third_party/github.com/marmotedu/errors/README.md"}
)
...
func Register(coder Coder) {
	if coder.Code() == 0 {
		panic("code `0` is reserved by `go-template/third_party/github.com/marmotedu/errors` as unknownCode error code")
	}
...
func MustRegister(coder Coder) {
	if coder.Code() == 0 {
		panic("code '0' is reserved by 'go-template/third_party/github.com/marmotedu/errors' as ErrUnknown error code")
	}
